...
public class ArithmeticController {
	...
	public Handler add = (ctx) -> {
		...
		// Double class
		// the Double class has a static method called parseDouble that can take a
		// String and return a double primitive representation of that String
		String number1String = ctx.formParam("number1");
		String number2String = ctx.formParam("number2");

		// String + double -> String + String = String
		ctx.result(arithmeticService.doAddition(number1String, number2String)); // Because number1 and number2 are just
																				// Strings, this will do String
																				// concatentation and not our actual
																				// adding of numbers
	};
	...
	public Handler subtract = (ctx) -> {
		...
		String number1String = ctx.formParam("number1");
		String number2String = ctx.formParam("number2");
		ctx.result(arithmeticService.doSubtraction(number1String, number2String)); // Because number1 and number2 are
																					// just Strings, this will do String
																					// concatentation and not our actual
																					// adding of numbers
	};
	...
	public Handler multiply = (ctx) -> {
		...
		// String + double -> String + String = String
		ctx.result(arithmeticService.doMultiplication(number1String, number2String)); // Because number1 and number2 are
																						// just Strings, this will do
																						// String concatentation and not
																						// our actual adding of numbers
	};
	...
	public Handler divide = (ctx) -> {
		...
		// String + double -> String + String = String
		ctx.result(arithmeticService.doDivide(number1String, number2String)); // Because number1 and number2 are just
																				// Strings, this will do String
																				// concatentation and not our actual
																				// adding of numbers
	};
